...
var routes = [{
        ...
        children: [
            ...
            { path: 'login/:id', component: __WEBPACK_IMPORTED_MODULE_2__login_login_component__["a" /* LoginComponent */] }
...
var LoginComponent = /** @class */ (function (_super) {
    ...
    function LoginComponent(injector, loginService, fb, router, route, sessionServer) {
        var _this = _super.call(this, injector) || this;
        ...
        var tenancyId = Number(_this.route.snapshot.paramMap.get('id'));
