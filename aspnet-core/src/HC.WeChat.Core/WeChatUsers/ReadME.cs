...
```
  ...
  Configuration.Modules.AbpAutoMapper().Configurators.Add(CustomerWeChatUserMapper.CreateMappings);
```
...
```
Configuration.Authorization.Providers.Add<WeChatUserAppAuthorizationProvider>();
```
